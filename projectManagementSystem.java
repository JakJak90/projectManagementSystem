...
/**
 * This class is for a project management system (PMS) for fictional
 * construction company "Poised".
 * <p>
 * The PMS is able to take in new project information, amend changing parameters
 * as the project progresses<br>
 * such as deadline and fees paid to date, display current and overdue projects
 * and read/write projects<br>
 * to output files for storage.
 * <p>
 * Methods used are outlined within the Project class and Person class.
 * 
